...
class RSSChecker:
    ...
    def should_notify_with_filters(self, title, keyword_id, keyword):
            ...
            for entry in feed.entries[:20]:
                ...
                for kw_row in keywords:
                    ...
                    if kw.lower() in title.lower():
                        if self.should_notify_with_filters(title, kw_id, kw):
                            matched.append(kw)
...
def monitor_loop(db, bot, checker):
    ...
    if monitor_state.system_notify:
        ...
        bot.send_message("🟢 <b>RSS监控 v3.9 时区修正版 已启动</b>", reply_markup=keyboard)
